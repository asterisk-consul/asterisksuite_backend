...
import { RequireAnyPermission } from '@/access-control/decorators/require-permissions.decorator';

@Controller('data-import')
export class DataImportController {
  constructor(private readonly service: DataImportService) {}

  @RequireAnyPermission('products.import', 'data_import.execute')
  ...
  @RequireAnyPermission('purchases.documents.import', 'data_import.execute')
  @Post('compras')
  @UseInterceptors(FileInterceptor('file'))
  ...
  @RequireAnyPermission('sales.documents.import', 'data_import.execute')
  @Post('ventas')
  @UseInterceptors(FileInterceptor('file'))
