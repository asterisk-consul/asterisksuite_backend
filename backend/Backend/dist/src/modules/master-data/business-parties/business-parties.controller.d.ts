...
export declare class BusinessPartiesController {
    private readonly service;
    constructor(service: BusinessPartiesService);
    create(dto: CreateBusinessPartyDto): Promise<{
        party_locations: ({
            locations: {
                id: string;
                created_at: Date;
    ...
    update(id: string, dto: UpdateBusinessPartyDto): Promise<{
        party_locations: ({
            locations: {
                id: string;
                created_at: Date;
