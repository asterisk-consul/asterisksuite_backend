...
export declare class CorridorsService {
    private prisma;
    ...
    getCorridorRoute(id: string): Promise<{
        id: string;
        name: string | null;
        total_distance_km: import("@prisma/client/runtime/client").Decimal | null;
        estimated_minutes: number | null;
    ...
    findOne(id: string): import("@/generated/prisma/internal/prismaNamespace").Prisma__corridorsClient<({
        corridorStops: ({
            location: {
                id: string;
                created_at: Date;
    ...
    remove(id: string): import("@/generated/prisma/internal/prismaNamespace").Prisma__corridorsClient<{
        name: string | null;
        id: string;
        created_at: Date;
        active: boolean;
