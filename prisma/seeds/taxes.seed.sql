...
-- =====================================================
INSERT INTO tenant.tax_categories (code, name, description, active)
VALUES
  ('GRAV_21', 'Gravado 21%', 'IVA al 21%', true),
  ('GRAV_105', 'Gravado 10.5%', 'IVA al 10.5%', true),
  ('GRAV_27', 'Gravado 27%', 'IVA al 27%', true),
  ('EXENTO', 'Exento', 'Sin IVA', true),
  ('NO_GRAV', 'No Gravado', 'No gravado, no genera credito fiscal', true)
...
INSERT INTO tenant.tax_category_taxes (tax_category_id, tax_id, is_included_in_price, active)
SELECT tc.id, t.id, false, true
