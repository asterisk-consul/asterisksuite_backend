...
CREATE TABLE "trip_rates" (
    ...
    CONSTRAINT "trip_rates_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "document_types" (
    ...
    "affects_tax_book" BOOLEAN NOT NULL DEFAULT false,
    "active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE INDEX "idx_dispatch_orders_company_id" ON "dispatch_orders"("company_id");
...
-- CreateIndex
CREATE INDEX "idx_trips_dispatch_order_id" ON "trips"("dispatch_order_id");
...
-- CreateIndex
CREATE INDEX "idx_vehicle_combinations_company_id" ON "vehicle_combinations"("company_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "corridors_company_id_name_key" ON "corridors"("company_id", "name");
...
-- AddForeignKey
ALTER TABLE "dispatch_orders" ADD CONSTRAINT "dispatch_orders_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "trips" ADD CONSTRAINT "trips_dispatch_order_id_fkey" FOREIGN KEY ("dispatch_order_id") REFERENCES "dispatch_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "vehicle_combinations" ADD CONSTRAINT "vehicle_combinations_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "transfer_rates" ADD CONSTRAINT "transfer_rates_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "trip_rates" ADD CONSTRAINT "trip_rates_rate_id_fkey" FOREIGN KEY ("rate_id") REFERENCES "transfer_rates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "trip_rates" ADD CONSTRAINT "trip_rates_trip_id_fkey" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "document_items" ADD CONSTRAINT "document_items_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
